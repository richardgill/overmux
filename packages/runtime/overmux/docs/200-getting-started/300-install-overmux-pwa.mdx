...
<Callout type="warning">
  PWAs must be hosted on HTTPS. See [Choose an HTTPS
  setup](./400-secure-with-https/100-choose-an-https-setup.md).
</Callout>
...
The eight image files are displayed unmodified, at reduced sizes. They match
[ntfy's documentation sources](https://github.com/binwiederhier/ntfy/tree/10cb6506f836dbb00bb77e3b52669f6ace37f555/docs/static/img)
and are used under the project's [Apache 2.0 license](https://github.com/binwiederhier/ntfy/blob/10cb6506f836dbb00bb77e3b52669f6ace37f555/LICENSE).
Copyright 2021 Philipp C. Heckel. This does not imply endorsement by ntfy or the browser vendors.

<details>
<summary>Screenshot license (Apache 2.0)</summary>
